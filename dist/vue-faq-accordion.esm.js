...
(function(){ if(typeof document !== 'undefined'){ var head=document.head||document.getElementsByTagName('head')[0], style=document.createElement('style'), css="*[data-v-dd43507e] { box-sizing: border-box; margin: 0; padding: 0; } button[data-v-dd43507e] { border: none; background: none; outline: none; } .faq[data-v-dd43507e] { width: 100%; padding: 0 10px; } .faq-wrapper[data-v-dd43507e] { max-width: 825px; margin: 0 auto; } .faq__title[data-v-dd43507e] { text-align: center; margin-bottom: 25px; } .faq__nav[data-v-dd43507e] { display: flex; justify-content: space-between; border: 2px solid #9E9E9E; border: 2px solid var(--border-color); border-radius: 5px; } .faq__nav-item[data-v-dd43507e] { height: 40px; flex: 1; display: flex; justify-content: center; align-items: center; border-right: 2px solid #9e9e9e; border-right: 2px solid var(--border-color); cursor: pointer; font-size: .8em; font-weight: 400; transition: all 0.3s; text-align: center; user-select: none; color: var(--font-color); } .faq__nav-item_active[data-v-dd43507e] { color: #D50000; color: var(--active-color); } .faq__nav-item[data-v-dd43507e]:hover { color: #D50000; color: var(--active-color); } .faq__nav-item[data-v-dd43507e]:last-child { border-right: none; } .faq__accordion[data-v-dd43507e] { min-height: 250px; } .accordion-fade-slide-enter-active[data-v-dd43507e], .accordion-fade-slide-leave-active[data-v-dd43507e] { transition: all 0.3s; } .accordion-fade-slide-enter[data-v-dd43507e] { transform: translateY(-25px); opacity: 0; } .accordion-fade-slide-leave-to[data-v-dd43507e] { transform: translateY(25px); opacity: 0; } .accordion[data-v-dd43507e] { border: 2px solid #9e9e9e; border: 2px solid var(--border-color); border-radius: 5px; margin-top: 15px; } .accordion__item[data-v-dd43507e] { border-bottom: 2px solid #9e9e9e; border-bottom: 2px solid var(--border-color); } .accordion__item[data-v-dd43507e]:last-child { border-bottom: none; } .accordion__title[data-v-dd43507e] { display: flex; justify-content: space-between; align-items: center; padding: 15px; cursor: pointer; transition: all 0.3s; color: var(--font-color); } .accordion__title_active[data-v-dd43507e] { color: var(--active-color); } .accordion__title[data-v-dd43507e]:hover { color: #D50000; color: var(--active-color); } .accordion__title:hover .accordion__toggle-button[data-v-dd43507e]::before, .accordion__title:hover .accordion__toggle-button[data-v-dd43507e]::after { background: #D50000; background: var(--active-color); } .accordion__title-text[data-v-dd43507e] { margin-right: 10px; font-size: .9rem; } .accordion__value[data-v-dd43507e] { padding: 0 25px 25px 25px; text-align: left; font-size: .8rem; color: var(--font-color); } .accordion__toggle-button[data-v-dd43507e] { position: relative; width: 16px; height: 16px; transition: all 0.3s; transform-origin: 50% 50%; padding-left: 16px; cursor: pointer; } .accordion__toggle-button[data-v-dd43507e]::before, .accordion__toggle-button[data-v-dd43507e]::after { content: ''; position: absolute; left: 0; width: 100%; height: 2px; transition: all 0.3s; background: black; } .accordion__toggle-button[data-v-dd43507e]::before { transform: rotate(90deg); } .accordion__toggle-button_active[data-v-dd43507e] { transform: rotate(45deg); } .accordion__toggle-button_active[data-v-dd43507e]::before, .accordion__toggle-button_active[data-v-dd43507e]::after { background: #D50000; background: var(--active-color); } "; style.type='text/css'; if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style); } })();
